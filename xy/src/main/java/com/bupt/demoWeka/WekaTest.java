...
public class WekaTest {
    public static void main(String[] args) throws Exception {
        ...
        // 训练语料文件
        File inputFile = new File("D:\\programming\\weka\\Weka-3-8\\data\\cpu.with.vendor.arff");
        ...
        // 测试语料文件
        inputFile = new File("D:\\programming\\weka\\Weka-3-8\\data\\cpu.with.vendor.arff");
        atf.setFile(inputFile);
        // 读入测试文件
